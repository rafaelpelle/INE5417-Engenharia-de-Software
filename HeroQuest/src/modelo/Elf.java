...
public class Elf extends PlayableCharacter {
	...
	public void createSpells() {
		Spell heal_Body = new Spell("Heal Body", Status.NEUTRAL, 4);
		Spell rock_Feet = new Spell("Rock Feet", Status.AGILITY_DOWN, 0);
		Spell rock_Skin = new Spell("Rock Skin", Status.ROCK_SKIN, 0);
